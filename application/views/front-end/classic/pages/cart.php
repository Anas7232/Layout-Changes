            ...
            <div class="col-md-4 mt-5">
                <div class="cart-product-summary">
                        ...
                        <table class="table cart-products-table">
                            ...
                            <tfoot>
                                ...
                                <tr class="total-price">
                                    ...
                                    <td class="text-danger"><?= $settings['currency'] . ' ' . $total ?></td>
                                </tr>
                                </tr>
                            </tfoot>
                        </table>
                    ...
                    <div class="checkout-method">
                        <a href="<?= base_url('cart/checkout') ?>" id="checkout"> <button class="block button-danger" <?= $disabled ?>><?= !empty($this->lang->line('go_to_checkout')) ? $this->lang->line('go_to_checkout') : 'Go To Checkout' ?></button></a>
                    </div>
                </div>
            </div>
        </div>
