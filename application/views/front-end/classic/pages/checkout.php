                        ...
                        <div class="shipped-details mt-3 col-md-6">
                            <table class="table table-step-shipping">
                                <tbody>
                                    ...
                                    <?php } ?>                                    	                                    	<tr>                                            <label for="cod">                                                <td>                                                    <label for="paytabs">                                                        <input id="paytabs" title="<?= isset($cart[0]['is_cod_allowed']) && $cart[0]['is_cod_allowed'] == 0 ? 'Cash on delivery is not allowed for one of the item in your cart' : 'Please select one of this options.' ?>" name="payment_method" type="radio" value="PAYTABS" <?= isset($cart[0]['is_cod_allowed']) && $cart[0]['is_cod_allowed'] == 0 ? 'disabled' : '' ?>>                                                    </label>                                                </td>                                                <td>                                                    <label for="paytabs">                                                        <img src="<?= THEME_ASSETS_URL . 'images/paytabs.png' ?>" class="payment-gateway-images" alt="PAYTABS">                                                    </label>                                                </td>                                                <td>                                                    <label for="paytabs">                                                        Pay Tabs                                                    </label>                                                </td>                                        </tr>
                    ...
                    <div class="checkout-order-wrapper">
                        ...
                        <div class="order-details">
                            <div class="product-checkout-wrapper">
                                    ...
                                    <table class="table cart-products-table">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="total-price">
                                                <td class="text-danger"><?= !empty($this->lang->line('total')) ? $this->lang->line('total') : 'Total' ?></td>
                                                <td class="text-danger"><?= $settings['currency'] ?> <span id="final_total"></span></td>
                                            </tr>
                                            </tr>
                                        </tfoot>
                                    </table>
                                ...
                                <button class="block button-danger" id="place_order_btn" type="submit" <?= ($is_disabled) ? "disabled" : ""; ?>><?= !empty($this->lang->line('place_order')) ? $this->lang->line('place_order') : 'Place Order' ?></button>
                            </div>
                        </div>
                    </div>
                </div>
