...
<div id="modal-custom" class="auth-modal" data-iziModal-group="group1">
    ...
    <section class="hide" id="login_div">
        <form action="<?= base_url('home/login') ?>" class='form-submit-event' method="post">
            ...
            <div class="mb-4 text-right">
                <a class="text-danger" href="<?= base_url() ?>" id="forgot_password_link"><?= !empty($this->lang->line('forgot_password')) ? $this->lang->line('forgot_password') : 'Forgot Password' ?> ?</a>
            </div>
            <footer>
                <button type="submit" data-iziModal-close><?= !empty($this->lang->line('cancel')) ? $this->lang->line('cancel') : 'Cancel' ?></button>
    ...
    <section id="register_div">
        ...
        </form>        <div class="row">        	<div class="col-lg-12 col-md-12">             	<div class="topbar-right" style="text-align:center;margin-top: 1vw;">                	<ul class="list-inline">                                                   <?php echo isset($facebookbtn) ? $facebookbtn: ''; ?>                         	                       	<?php echo isset($googlebtn) ? $googlebtn : ''; ?>                       							<li><a href="javascript:;"><img src="<?= base_url()?>/uploads/social/apple.svg" width="33"></a></li>                                             	</ul>             	</div>          	</div>		</div>
    </section>
...
<?php } ?>
<script type="text/javascript">$(window).scroll(function(){    if($(window).scrollTop() > 10){        $("#topRedbar").slideUp();    } else {    	$("#topRedbar").slideDown();    }})</script>
<!-- end -->
<!-- main content ends -->