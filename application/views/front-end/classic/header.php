 ...
 <div id="mySidenav" class="sidenav is-closed-left">
     ...
     <div class="container">
         <div class="row">
             <div class="col-12">
                 <input class='form-control' name="search" placeholder="Search for products" />
             </div>
         </div>
     </div>
     <hr>
 ...
 <header id="header" class="topper-white header-varient pos-fix">
     <div class="topbar topbar-text-color" id="topRedbar">
 ...
 </header> <section class="dummy-section"></section>
<!--
