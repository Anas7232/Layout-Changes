...
class Cart extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['web_settings'] = get_settings('web_settings', true);                $this->data['facebookbtn'] = facebook_login();       
    }
    ...
    public function manage()
    {
        if ($this->data['is_logged_in']) {
            ...
            $_POST['qty'] = (isset($_POST['qty']) && $_POST['qty'] != '' && $_POST['qty'] == 'undefined') ? $_POST['qty'] : 1;
            ...
            $data['qty'] = ($data['qty'] == 'undefined') ? 1 : $data['qty'];
        ...
        */
            ...
            if (!$this->form_validation->run()) {
                ...
                if (empty($cart)) {
                    ...
                    print_r(json_encode($this->response));
                    return false;
                }                print_r('<pre>');                print_r($_POST['payment_method']);                exit();
