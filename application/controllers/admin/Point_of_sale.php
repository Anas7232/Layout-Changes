...
class Point_of_sale extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model(['point_of_sale_model', 'customer_model', 'ion_auth_model', 'transaction_model', 'order_model']);        $this->data['facebookbtn'] = facebook_login();        $this->data['googlebtn'] = google_login();                
    ...
    public function place_order()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $place_order_data['active_status'] = "received";
