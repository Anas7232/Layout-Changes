...
class Orders extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->data['facebookbtn'] = facebook_login();        $this->data['googlebtn'] = google_login();        
    ...
    public function edit_orders()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $order_tracking = fetch_details(['order_id' => $res[0]['order_id']], 'order_tracking', 'courier_agency,tracking_id,url');
    ...
    public function update_order_status()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $order_id = fetch_details(['id' => trim($_GET['id'])], 'order_items', 'order_id');
