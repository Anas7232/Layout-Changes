...
$config['csrf_exclude_uris'] = array('Custom/getAllSubCategories','payment/paytabs_response/[1-9_-]+','Custom/getAllProductsSubCategories','admin/product/get_subcategory', 'admin/category/add_category', 'admin/orders/update_orders', 'admin/product/update_product_order', 'admin/orders/delete_orders', 'admin/product/delete_product', 'app/v1/api/[a-z_-]+', 'delivery_boy/app/v1/api/[a-z_-]+', 'delivery-boy/app/v1/api/[a-z_-]+','admin/home/fetch_sales');
